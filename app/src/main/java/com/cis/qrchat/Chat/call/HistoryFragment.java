...
import com.cis.qrchat.Chat.utils.ToastUtils;
...
public class HistoryFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        whiteNotificationBar(mRecyclerViewHistory);
        mRecyclerViewHistory.addItemDecoration(new MyDividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL, 0));
