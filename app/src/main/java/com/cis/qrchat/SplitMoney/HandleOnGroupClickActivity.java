...
public class HandleOnGroupClickActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * Hence, we can load all the members and bills of the group the user clicked on in GroupList Activity*/
        ...
        adapter.addFragment(MembersTabFragment.newInstance(gName),getResources().getString(R.string.members));
        ...
        adapter.addFragment(ExpensesTabFragment.newInstance(gName),getResources().getString(R.string.expenses));
        ...
        adapter.addFragment(BalancesTabFragment.newInstance(gName),getResources().getString(R.string.balances));
