...
public class MembersTabViewAdapter extends RecyclerView.Adapter<MembersTabViewAdapter.MyViewHolder> {

    private Context context;
    private List<GetGroupMembers.ListResult> groupList;
    private List<GetGroupMembers.ListResult> groupMembersList;
    private GroupMemberdapterAdapterListner listener;
        ...
        public MyViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    listener.onGroupMemberSelected(groupMembersList.get(getAdapterPosition()));
    ...
    public MembersTabViewAdapter(Context context, List<GetGroupMembers.ListResult> groupList, GroupMemberdapterAdapterListner listener) {
    ...
    public interface GroupMemberdapterAdapterListner {
        void onGroupMemberSelected(GetGroupMembers.ListResult groupmembers);
    }
