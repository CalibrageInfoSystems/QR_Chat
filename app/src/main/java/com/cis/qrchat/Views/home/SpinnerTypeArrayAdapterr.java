...
class SpinnerTypeArrayAdapterr extends ArrayAdapter<TypeItems> {

    public SpinnerTypeArrayAdapterr(Context context,
                                   ArrayList<TypeItems> algorithmList)
    {
                          ...
                          ViewGroup parent)
    {
        ...
        TypeItems currentItem = getItem(position);
