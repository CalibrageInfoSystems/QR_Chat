...
public class SearchContactlist extends AppCompatActivity implements ContactListAdapter.ContactsAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_contactlist);
        intviews();
        setviews();
        settoolbar();
    }
...
//                startActivity(intent);
                ...
                .observeOn(AndroidSchedulers.mainThread()).subscribe(new Subscriber<Getcontactlist>() {
                    ...
                    public void onNext(Getcontactlist getcontactlist) {
                        ...
                        if(getcontactlist.getListResult()!=null){
                            ...
                            contactListAdapter = new ContactListAdapter(SearchContactlist.this, getcontactlist.getListResult(), SearchContactlist.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchIcon.setImageDrawable(ContextCompat.getDrawable(this,R.drawable.ic_searchh));
    ...
    private void createGroupChannel(List<String> userIds, boolean distinct) {
        GroupChannel.createChannelWithUserIds(userIds, distinct, new GroupChannel.GroupChannelCreateHandler() {
            ...
            public void onResult(GroupChannel groupChannel, SendBirdException e) {
                ...
                Intent intent = new Intent(SearchContactlist.this, GroupChannelActivity.class);
